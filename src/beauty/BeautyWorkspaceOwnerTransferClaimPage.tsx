...
const copy: Record<Language, Record<ViewState | "title" | "googleAction" | "back", string>> = {
  ...
  pl: { title: "Workspace ownership transfer", checking: "Checking the link…", google_required: "Sign in with Google. After your identity is verified, the superadmin will receive an approval request.", googleAction: "Sign in with Google", claiming: "Verifying your account…", pending: "Your account is verified. Waiting for superadmin approval. This page will update automatically.", approved: "Transfer approved. Opening the workspace…", rejected: "The superadmin rejected the workspace transfer.", expired: "This link expired or was revoked.", conflict: "This account cannot become the workspace owner.", unavailable: "Could not check the request. Try again later.", back: "Back to Services" },
  sk: { title: "Změna vlastníka kabinetu", checking: "Kontrolujeme odkaz…", google_required: "Přihlaste se přes Google. Po ověření dostane superadmin žádost o schválení převodu kabinetu.", googleAction: "Přihlásit přes Google", claiming: "Ověřujeme váš účet…", pending: "Účet je ověřen. Čekáme na rozhodnutí superadmina. Stránka se aktualizuje automaticky.", approved: "Převod byl schválen. Otevíráme kabinet…", rejected: "Superadmin převod kabinetu zamítl.", expired: "Odkaz vypršel nebo byl odvolán.", conflict: "Tento účet se nemůže stát vlastníkem kabinetu.", unavailable: "Žádost se nepodařilo ověřit. Zkuste to později.", back: "Zpět na služby" },
};
