...
describe("Akce001B Telegram City Posters publication",()=>{
 ...
 it("routes tracked City Posters into the resolved city forum topic",()=>{expect(src).toContain("resolveCityTelegramTopicId");expect(src).toContain("message_thread_id:messageThreadId")});
