...
.cinema-details-page{position:fixed;z-index:3900;inset:0;overflow-y:auto;overscroll-behavior:contain;background:#090a0c;color:#fff}
.cinema-details-header{position:sticky;z-index:5;top:0;min-height:56px;display:grid;grid-template-columns:40px minmax(0,1fr) 40px;align-items:center;gap:8px;padding:max(8px,env(safe-area-inset-top)) 12px 8px;border-bottom:1px solid rgba(255,255,255,.08);background:rgba(9,10,12,.94)}.cinema-details-header strong{overflow:hidden;font-size:13px;text-align:center;text-overflow:ellipsis;white-space:nowrap}.cinema-details-header button{width:36px;height:36px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:rgba(255,255,255,.05);color:#fff}.cinema-details-header svg{width:18px;height:18px}
.cinema-details-content{width:min(100%,720px);margin:0 auto;display:grid;gap:20px;padding:16px 14px 132px}.cinema-details-hero{display:grid;grid-template-columns:112px minmax(0,1fr);gap:14px;align-items:end}.cinema-details-poster{overflow:hidden;display:grid;place-items:center;aspect-ratio:2/3;border-radius:16px;background:#18191d}.cinema-details-poster img{width:100%;height:100%;object-fit:cover}.cinema-details-heading{min-width:0;display:grid;gap:8px}.cinema-details-heading h1{margin:0;font-size:clamp(25px,8vw,38px);line-height:1;letter-spacing:-.035em}.cinema-details-heading p{margin:0;color:#9ca3af;font-size:12px}.cinema-details-facts{display:flex;flex-wrap:wrap;gap:5px}.cinema-details-facts span{padding:4px 7px;border-radius:999px;background:rgba(255,255,255,.07);color:#c8cbd0;font-size:9px;font-weight:760}
.cinema-details-badges{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.cinema-details-badges>*{min-width:0;min-height:64px;display:grid;grid-template-columns:22px 1fr;grid-template-rows:auto auto;align-content:center;column-gap:7px;padding:10px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:#15171b;color:#fff;text-align:left;font:inherit}.cinema-details-badges svg{grid-row:1/3;align-self:center;width:18px;height:18px;color:#d4af37}.cinema-details-badges span{color:#9ca3af;font-size:9px}.cinema-details-badges strong{font-size:12px}
.cinema-details-about,.cinema-details-credits,.cinema-details-schedule-section{display:grid;gap:10px}.cinema-details-about h2{margin:0;font-size:17px}.cinema-details-about p{margin:0;color:#c8cbd0;font-size:12px;line-height:1.55}.cinema-details-credits>div{display:grid;gap:4px;padding:11px 12px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:#15171b}.cinema-details-credits small,.cinema-details-section-heading small{color:#9ca3af;font-size:9px;text-transform:uppercase;letter-spacing:.06em}
.cinema-details-section-heading{display:flex;align-items:center;justify-content:space-between;gap:10px}.cinema-details-section-heading h2{margin:3px 0 0;font-size:18px}.cinema-details-section-heading button{display:inline-flex;align-items:center;gap:6px;padding:8px 10px;border:1px solid rgba(255,255,255,.14);border-radius:11px;background:rgba(255,255,255,.05);color:#fff;font:inherit;font-size:10px;font-weight:850}
.cinema-details-venue{display:grid;gap:8px;padding:12px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:#15171b}.cinema-details-venue-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}.cinema-details-back{width:32px;height:32px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:rgba(255,255,255,.05);color:#fff}.cinema-details-times{display:flex;flex-wrap:wrap;gap:7px}.cinema-details-times>a,.cinema-details-times>button,.cinema-details-times>span{display:grid;gap:2px;min-width:67px;padding:8px 9px;border:1px solid rgba(255,255,255,.14);border-radius:10px;background:rgba(255,255,255,.04);color:#fff;text-decoration:none}.cinema-details-times>button{font:inherit;text-align:left}.cinema-details-times strong{font-size:13px}
.cinema-details-sticky-actions{position:fixed;z-index:6;left:0;right:0;bottom:0;display:grid;grid-template-columns:1fr;gap:7px;padding:10px 12px max(10px,env(safe-area-inset-bottom));border-top:1px solid rgba(255,255,255,.08);background:rgba(9,10,12,.96)}.cinema-details-sticky-actions>div{min-width:0;display:flex;align-items:center;gap:7px;padding:7px 8px;border-radius:11px;background:rgba(255,255,255,.04)}.cinema-details-sticky-actions>button{min-height:44px;display:inline-flex;align-items:center;justify-content:center;gap:8px;border:2px solid #d4af37;border-radius:13px;background:rgba(212,175,55,.12);color:#f2d56d;font:inherit;font-weight:900}
`;
    ...
    <div className="cinema-details-page" role="dialog" aria-modal="true" aria-label={row.movie_title}>
      ...
      <main className="cinema-details-content">
        <div className="cinema-details-hero">
          <div className="cinema-details-poster">{detailsPosterUrl ? <img src={detailsPosterUrl} alt={row.movie_title} /> : <Film />}</div>
...
export function CinemaPostersCatalog({
  ...
  if (variant === "catalog") return <><style data-go-irl-cinema-runtime-fallback>{cinemaRuntimeFallbackCss}</style><div className="cinema-catalog-grid cinema-beauty-card-grid">{groups.map((group) => <CatalogMovieCard
    group={group}
    language={language}
    plannedDate={plannedByMovie.get(group.movieId)}
  ...
  return <><style data-go-irl-cinema-runtime-fallback>{cinemaRuntimeFallbackCss}</style><div className="cinema-catalog-grid cinema-beauty-card-grid">{groups.map((group) => <ForYouMovieCard
    group={group}
    language={language}
    plannedDate={plannedByMovie.get(group.movieId)}
    plannedSurface
