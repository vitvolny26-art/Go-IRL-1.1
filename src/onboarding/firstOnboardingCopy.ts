...
const copy: Record<Language, FirstOnboardingCopy> = {
  ru: {
    ...
    terms: "Условия использования GO IRL",
    acceptPrivacy: "Подтверждаю, что у меня была возможность ознакомиться с",
    ...
    confirmationsError: "Подтвердите 18+, Условия и ознакомление с Политикой конфиденциальности.",
  ...
  uk: {
    ...
    terms: "Умови використання GO IRL",
    acceptPrivacy: "Підтверджую, що мав(ла) можливість ознайомитися з",
    ...
    confirmationsError: "Підтвердьте 18+, Умови та ознайомлення з Політикою конфіденційності.",
  ...
  cs: {
    ...
    terms: "Podmínkami používání GO IRL",
    acceptPrivacy: "Potvrzuji, že jsem měl(a) možnost seznámit se se",
    ...
    confirmationsError: "Potvrďte věk 18+, Podmínky a seznámení se Zásadami ochrany osobních údajů.",
  ...
  en: {
    ...
    terms: "GO IRL Terms of Use",
    acceptPrivacy: "I confirm I had the opportunity to review the",
    ...
    confirmationsError: "Confirm 18+, Terms, and that you had the opportunity to review Privacy to continue.",
