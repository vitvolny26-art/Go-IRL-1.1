...
describe("Activ015 Activity publication quota and Organizer gate", () => {
  ...
  it("covers both existing single and recurring creation paths without a second frontend quota authority", () => {
    ...
    expect(migration).not.toContain("create table public.activity_publish_quota");
  });
  ...
  it("ships a structural verifier for the protected migration", () => {
    expect(verifier).toContain("activ015_daily_publish_trigger_missing");
