...
export type EventNotificationKind =
  ...
  | "event_changed" | "event_cancelled" | "social.favorited" | "social.favorite_organizer_event_created"
  | "services.booking_requested" | "services.booking_confirmed" | "services.booking_declined" | "services.booking_cancelled"
...
export type EventNotificationPayload = {
  ...
  feedbackResponseCount?: number; feedbackRatingCount?: number; feedbackAverageRating?: number | null;
