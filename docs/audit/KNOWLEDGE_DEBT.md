...
|---|---|---|---|---|---|---|---|
| KD-005 | Strategic docs lack YAML frontmatter | Metadata debt | High | Project Archivist | Open | 2026-07-31 | Validated against `main@ff72241` on 2026-08-13: `docs/GO_IRL_PRODUCT.md`, `docs/Security.md`, and `supabase/README.md` still lack the required YAML metadata. Keep Open until canonical metadata is added. |
...
| KD-008 | `supabase/README.md` is source-of-truth but has no Knowledge Status metadata | Metadata debt | High | Supabase Steward | Open | 2026-07-31 | Validated against `main@ff72241` on 2026-08-13: `supabase/README.md` still starts without Knowledge Status YAML. Keep Open; metadata alignment only, no schema/RLS/auth change is implied. |
