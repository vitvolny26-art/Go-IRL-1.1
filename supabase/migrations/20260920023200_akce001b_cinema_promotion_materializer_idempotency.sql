-- Akce001B: forward-fix production materializer idempotency after multi-city materialization.
-- Reapplies the current canonical function definition so production converges without duplicate offers.
