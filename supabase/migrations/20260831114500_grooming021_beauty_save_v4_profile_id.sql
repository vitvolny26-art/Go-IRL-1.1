-- GROOMING021: remove the ambiguous profile_id reference from Beauty save v4.
begin;
...
begin
  ...
  loop
    ...
    update public.beauty_professional_services as service_row
    set service_name_i18n = public.go_irl_beauty_i18n_sanitize(v_item -> 'name_i18n', 120)
    where service_row.profile_id = v_result.profile_id
      and service_row.client_key = v_client_key
      and service_row.archived = false;
  end loop;
